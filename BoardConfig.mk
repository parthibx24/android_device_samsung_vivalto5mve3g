...
# Config From vivalto5mve3g Platfrom source
TARGET_USERIMAGES_SPARSE_EXT_DISABLED := true
BOARD_USES_ALSA_AUDIO := true
# Worst Config-Disable this
...
TARGET_KERNEL_CONFIG := apias_defconfig
TARGET_KERNEL_SOURCE := kernel/samsung/apias
...
# Assert
TARGET_OTA_ASSERT_DEVICE := SM-G316M,SM-G316HU,vivalto5mve3g,vivalto5mvexx
...
# CMHW
BOARD_HARDWARE_CLASS := device/samsung/vivalto5mve3g/cmhw/
...
TWHAVE_SELINUX := true
TARGET_RECOVERY_INITRC := device/samsung/vivalto5mve3g/etc/init.rc
TARGET_RECOVERY_FSTAB := device/samsung/vivalto5mve3g/ramdisk/recovery.fstab
